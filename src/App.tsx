...
function Hero() {
  ...
  const overlayOpacity = Math.max(0, 1 - scrollProgress * 2.5);

  return (
    <section className="hero-engine" id="top" ref={heroRef}>
      <div className="hero-engine__canvas-wrap">
        <Suspense fallback={null}>
          <CinematicHero progress={scrollProgress} reducedMotion={reducedMotion} />
        </Suspense>
      </div>

      <div className="hero-engine__overlay" style={{ opacity: overlayOpacity }}>
        <div className="hero-engine__eyebrow">
          <span className="live-dot" />
          <span>ai.drsfilms.com / 2026 / AI portfolio</span>
        </div>
        <p className="hero-engine__identity">Eric Zheng &middot; Film Producer &amp; AI Systems Builder</p>
        <h1>
          I produce films.
          <br />
          I build AI systems.
        ...
        <div className="hero-engine__actions">
      ...
      <div className="hero-engine__dashboard">
